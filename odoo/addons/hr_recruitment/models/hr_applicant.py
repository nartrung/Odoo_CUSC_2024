...
class Applicant(models.Model):
    ...
    x_partner_gender = fields.Selection([('Nam','Nam'),('Nữ','Nữ'),('Khác','Khác')],string="Giới tính")
    x_partner_date_of_birth = fields.Date(string="Ngày sinh")
    x_partner_ethnicity = fields.Char(string="Dân tộc")
    x_partner_religion = fields.Char(string="Tôn giáo")
    x_partner_city = fields.Char(string="Địa chỉ")
    x_partner_district = fields.Char(string="Quận/Huyện")
    x_partner_ward = fields.Char(string="Phường/Xã")
    x_partner_address = fields.Char(string="Số nhà/Đường")
    x_partner_identify_id = fields.Char(string="CMND/CCCD")
    x_partner_marital_status = fields.Selection([('Độc thân','Độc thân'),('Đã kết hôn','Đã kết hôn'),('Đã ly hôn','Đã ly hôn')],string="Tình trạng hôn nhân")
    x_partner_emergency_contact = fields.Text(string="Liên hệ khẩn cấp")
    x_partner_youth_nion_join_date = fields.Date(string="Ngày vào Đoàn")
    x_partner_party_join_date = fields.Date(string="Ngày vào Đảng")
    x_partner_relative = fields.Text(string="Quan hệ gia đình")
    x_partner_study = fields.Text(string="Quá trình học tập")
    x_partner_experiences = fields.Text(string="Kinh nghiệm")
    x_partner_reason_for_work = fields.Text(string="Lý do dự tuyển")
    x_partner_time_can_work = fields.Char(string="Thời gian có thể cộng tác")
    x_partner_company_relative = fields.Char(string="Người quen làm việc tại CUSC")
    x_partner_strengths = fields.Text(string="Điểm mạnh")
    x_partner_weaknesses = fields.Text(string="Điểm yếu")
    x_partner_plan_for_future = fields.Text(string="Dự định tương lai")
    x_partner_how_to_know_the_applicant = fields.Text(string="Lý do biết đến tuyển dụng")
